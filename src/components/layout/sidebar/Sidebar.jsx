      ...
      {openGroups[groupIndex] &&
        ...
        //   >
            <div
              ...
              onDragStart={(event) => onDragStart(event, icon.onDragStart)}
              draggable
            >
  ...
  const sidemenuIconGroups = [
    // Group 1
    {
      ...
      children: [
        {
          title: "Chemical Feed",
          onDragStart: "customnode_chemical_dosing",
          src: Chemical_Dosing,
          text: "Chemical Feed",
        ...
        {
          title: "STR",
          onDragStart: "customnode_stripper",
          src: stripperImage,
          text: "CIP",
          packagedSystemLevel1QualifierFullProposal: true,
          packagedSystemFirmProposal: true,
        ...
        {
          title: "CF",
          onDragStart: "customnode_cartridgefilter",
          src: CF_new,
        ...
        {
          title: "Storage Tank",
          onDragStart: "customnode_storagetank",
          src: Pump,
          text: "Storage Tank",
          packagedSystemLevel1QualifierFullProposal: true,
          packagedSystemFirmProposal: true,
        ...
        {
          title: "UVLight",
          onDragStart: "customnode_uvlight",
          src: uv,
          text: "UV Light",
          packagedSystemLevel1QualifierFullProposal: true,
          packagedSystemFirmProposal: true,
